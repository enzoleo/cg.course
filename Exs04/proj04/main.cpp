...
bool bTableList = true;
bool bBunnyList = true;
bool bTeapotList = true;
...
void drawScene()
{
	...
	if (bBunnyList) drawBunnyList();
	if (bTeapotList) drawTeapotList();
	if (bTableList) drawTableList();
}
...
void key(unsigned char k, int x, int y)
{
	...
	case '1': { bTableList = !bTableList; break; }
	case '2': { bTeapotList = !bTeapotList; break; }
	case '3': { bBunnyList = !bBunnyList; break; }
	default: break;
	}
}
